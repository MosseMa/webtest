...
<html>
<head>
	<title>KOHLER_BFO MDSS,smart factory</title>
	<meta charset="utf-8">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<button type="button" class="btn btn-primary">Quality</button>
					<button type="button" class="btn btn-primary">Labor_hour</button>
						...
						<div class="col-md-6">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Foundry</h3>
								</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Polishing</h3>
								</div>
								<div class="panel-body">
