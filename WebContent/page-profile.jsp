	...
	<div id="wrapper">
		...
		<div class="brand">
			<a href="index.jsp"><img src="assets/img/logo-dark.png"
				alt="kohlerbfo Logo" class="img-responsive logo"></a>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"><img src="assets/img/user.png"
							class="img-circle" alt="Avatar"> <span>Mosse</span> <i
							class="icon-submenu lnr lnr-chevron-down"></i></a>
						<ul class="dropdown-menu">
							<li><a href="page-profile.jsp"><i class="lnr lnr-user"></i>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
				<ul class="nav">
					<li><a href="homepage.jsp" class="active"><i
							class="lnr lnr-home"></i> <span>Homepage</span></a></li>
					<li><a href="opreation-charts.jsp" class=""><i
							class="lnr lnr-chart-bars"></i> <span> Opreation Charts</span></a></li>
					<li><a href="panels.jsp" class=""><i class="lnr lnr-cog"></i>
							<span>Panels</span></a></li>
					<li><a href="#subPages" data-toggle="collapse"
						class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Tools</span>
					...
					<div class="panel panel-profile">
						<div class="clearfix">
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											<li>Birthdate <span>24 Mar, 1991</span></li>
											<li>Mobile <span>secret</span></li>
											<li>Email <span>Zhifu.ma@kohler.com</span></li>
											<li>Website <span><a href="location('www.mosse.wang')">www.mosse.wang</a></span></li>
										</ul>
									</div>
									<div class="profile-info">
										<h4 class="heading">Social</h4>
										<ul class="list-inline social-icons">
											<li><a href="www.facebook.com" class="facebook-bg"><i
													class="fa fa-facebook"></i></a></li>
											<li><a href="www.twitter.com" class="twitter-bg"><i
													class="fa fa-twitter"></i></a></li>
											<li><a href="www.goole.com" class="google-plus-bg"><i
													class="fa fa-google-plus"></i></a></li>
											<li><a href="www.github.com" class="github-bg"><i
													class="fa fa-github"></i></a></li>
										</ul>
									</div>
									<div class="profile-info">
										<h4 class="heading">About</h4>
										<p>it is a test website and it is under building</p>
									</div>
							...
							<div class="profile-right">
								<h4 class="heading">Mosse's Awards</h4>
								<!-- AWARDS -->
								<div class="awards">
									<div class="row">
		...
		<div class="container-fluid">
			<p class="copyright">
				&copy; 2018 <a href="#" target="_blank">KOHLER_BFO</a>. All Rights
				Reserved by KOHLER_BFO <a href="http://www.kohler.com"
					target="_blank" title="科勒中国">科勒中国</a>
			</p>
		</div>
		</footer>
	</div>
